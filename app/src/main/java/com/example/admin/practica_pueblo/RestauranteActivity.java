...
public class RestauranteActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: restaurante_1 tab1 = new restaurante_1();
                    return tab1;
                case 1: restaurante_2Fragment tab2 = new restaurante_2Fragment();
                    return tab2;
                case 2: restaurante_3Fragment tab3 = new restaurante_3Fragment();
                    return tab3;
                default: return null;
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                ...
                case 2:
                    return getResources().getString(R.string.resttres);
            }
            return null;
        }
    }
